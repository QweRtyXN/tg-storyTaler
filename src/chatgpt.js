...
const getMessage = (m) => `
    ...
    Это тезисы с описанием ключевых моментов дня. Необходимо в итоге получить такую историю, чтобы я смог запомнить этот день и впоследствии рассказал ее друзьям. Текст не должен быть больше 150 слов, главное чтобы были эмоции, правильная последовательность + учтение контекста
`
